        ...
        <div className="px-4 py-6 bg-white shadow-xl sm:px-10 border-2 rounded-md border-emerald-800 font-Lora font-medium">
          ...
          <form onSubmit={submitLogin} className="space-y-6" noValidate>
            ...
            <div>
              ...
              type="submit"
              className="-mt-4 mb-5 block text-sm text-gray-900 hover:underline">
              Glömt ditt lösenord?
              </Link>
            </div>  
              <button
                type="submit"
                className="flex justify-center mt-2 w-full px-4 py-2 text-sm font-bold text-white border font-Lora bg-green-800 border-emerald-800 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-800 transition-transform  hover:scale-110 hover:bg-green-800  "
              >Logga in
              </button>
                <div className="text-center w-full items-center text-sm grid grid-cols-3 mt-3 ">
